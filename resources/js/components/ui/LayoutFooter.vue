            ...
            <div class="footer">
                <div class="column">
                    <div class="logo">
                        <div class="logo"></div>
                        <div class="socials">
                            <div class="social" onclick="window.open('https://vk.com/x20bet', '_blank')"><icon icon="fab fa-vk"></icon></div>
                    ...
                    <div class="info">
                        ...
                        <a href="mailto:support@crypto-casino.online">support@crypto-casino.online</a>
                    </div>
                </div>
                <div class="column">
                    <div class="copy">
                    ...
                    <div class="w5x-team" onclick="window.open('https://playin.team', '_blank')"><img src="/img/misc/win5x_logo_white.png" alt> Win5X Team</div>
