            ...
            <div class="glide" id="slider">
                <div class="glide__track" data-glide-el="track">
                    <ul class="glide__slides">
                        <li class="glide__slide" style="background-image: url('/img/misc/slider/slider2.svg')">
                            <div class="slideContent right">
                                <div class="slideContentWrapper">
                                    <div class="header">
                                        <div class="image" style="background-image: url('/img/misc/logo.png')"></div>
                                    </div>
                        ...
                        <li class="glide__slide" style="background-image: url('/img/misc/slider/slider3.png')"></li>
                    </ul>
                </div>
