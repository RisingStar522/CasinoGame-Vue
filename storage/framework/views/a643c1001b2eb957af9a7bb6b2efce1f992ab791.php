                ...
                <?php else: ?>
                    <?php $__currentLoopData = \App\Withdraw::where('status', 0)->latest()->take(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $withdraw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="media border-top pt-3">
                            <img src="<?php echo e($user->avatar); ?>" class="avatar rounded mr-3" alt="shreyu">
                            <div class="media-body">
                                <h6 class="mt-1 mb-0 font-size-15"><?php echo e($user->name); ?></h6>
                                <h6 class="text-muted font-weight-normal mt-1 mb-3"><?php echo e(number_format($withdraw->sum, 8, '.', ' ')); ?> <?php echo e(\App\Currency\Currency::find($withdraw->currency)->name()); ?></h6>
                            </div>
                        </div>
...
<?php /**PATH D:\xampp\htdocs\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>