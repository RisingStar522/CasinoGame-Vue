...
import { AddressCoinSpecific, BaseCoin, ExtraPrebuildParamsOptions, KeychainsTriplet, PrecreateBitGoOptions, PresignTransactionOptions, SignedTransaction, SupplementGenerateWalletOptions, TransactionParams as BaseTransactionParams, TransactionPrebuild as BaseTransactionPrebuild, VerificationOptions, VerifyAddressOptions as BaseVerifyAddressOptions, VerifyRecoveryTransactionOptions, VerifyTransactionOptions } from '../baseCoin';
...
export declare abstract class AbstractUtxoCoin extends BaseCoin {
     ...
     */
    deriveKeys(keyArray: bitcoin.HDNode[], index: number): any[];
    /**
    ...
    signMessage(key: {
        prv: string;
    }, message: string | Buffer, callback?: NodeCallback<Buffer>): Bluebird<Buffer>;
}
