...
exports.ABI = [
    ...
    {
        anonymous: false,
        inputs: [{ indexed: false, name: 'size', type: 'uint256' }],
        name: 'MaxGroupSizeSet',
        type: 'event',
    },
    {
        anonymous: false,
        inputs: [{ indexed: false, name: 'delay', type: 'uint256' }],
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, name: 'exponent', type: 'uint256' },
            { indexed: false, name: 'adjustmentSpeed', type: 'uint256' },
        ],
    ...
    {
        anonymous: false,
        inputs: [{ indexed: false, name: 'length', type: 'uint256' }],
    ...
    },
    {
        ...
        inputs: [
            { indexed: true, name: 'validator', type: 'address' },
            { indexed: false, name: 'ecdsaPublicKey', type: 'bytes' },
        ],
    ...
    },
    {
        ...
        inputs: [
            { indexed: true, name: 'validator', type: 'address' },
            { indexed: false, name: 'blsPublicKey', type: 'bytes' },
        ],
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, name: 'epochScore', type: 'uint256' },
        ],
    ...
    },
    {
        ...
        inputs: [
            { indexed: true, name: 'group', type: 'address' },
            { indexed: false, name: 'commission', type: 'uint256' },
            { indexed: false, name: 'activationBlock', type: 'uint256' },
        ],
    ...
    },
    {
        ...
        inputs: [
            { indexed: true, name: 'validator', type: 'address' },
            { indexed: false, name: 'validatorPayment', type: 'uint256' },
            { indexed: true, name: 'group', type: 'address' },
            { indexed: false, name: 'groupPayment', type: 'uint256' },
        ],
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'groupRequirementValue', type: 'uint256' },
            { name: 'groupRequirementDuration', type: 'uint256' },
            { name: 'validatorRequirementValue', type: 'uint256' },
            { name: 'validatorRequirementDuration', type: 'uint256' },
            { name: 'validatorScoreExponent', type: 'uint256' },
            { name: 'validatorScoreAdjustmentSpeed', type: 'uint256' },
            { name: '_membershipHistoryLength', type: 'uint256' },
            { name: '_slashingMultiplierResetPeriod', type: 'uint256' },
            { name: '_maxGroupSize', type: 'uint256' },
            { name: '_commissionUpdateDelay', type: 'uint256' },
        ],
        name: 'initialize',
        outputs: [],
        payable: false,
    ...
    },
    {
        ...
        inputs: [
            { name: 'exponent', type: 'uint256' },
            { name: 'adjustmentSpeed', type: 'uint256' },
        ],
    ...
    {
        constant: true,
        inputs: [{ name: 'uptime', type: 'uint256' }],
    ...
    {
        constant: true,
        inputs: [{ name: 'uptimes', type: 'uint256[]' }],
    ...
    },
    {
        ...
        outputs: [{ name: 'blsPublicKey', type: 'bytes' }],
        payable: false,
        stateMutability: 'view',
        type: 'function',
    },
    ...
    {
        constant: false,
        inputs: [{ name: 'validatorAccount', type: 'address' }],
