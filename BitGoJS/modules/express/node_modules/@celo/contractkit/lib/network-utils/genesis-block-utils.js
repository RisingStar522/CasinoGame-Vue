...
var TAG = 'genesis-block-utils';
exports.GenesisBlocksGoogleStorageBucketName = 'genesis_blocks';
var GenesisBlockUtils = /** @class */ (function () {
    function GenesisBlockUtils() {
    }
    /**
     ...
     */
    GenesisBlockUtils.getGenesisBlockAsync = function (networkName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                console.debug(TAG + " getGenesisBlockAsync(\"" + networkName + "\") called");
                return [2 /*return*/, google_storage_utils_1.GoogleStorageUtils.fetchFileFromGoogleStorage(exports.GenesisBlocksGoogleStorageBucketName, networkName)];
            });
        });
    };
    GenesisBlockUtils.getChainIdFromGenesis = function (genesis) {
        try {
