...
var google_storage_utils_1 = require("./google-storage-utils");
// The bucket where we store static_nodes information for all the networks.
var StaticNodesGoogleStorageBucketName = "static_nodes";
var StaticNodeUtils = /** @class */ (function () {
    function StaticNodeUtils() {
    }
    StaticNodeUtils.getStaticNodesGoogleStorageBucketName = function () {
     ...
     */
    StaticNodeUtils.getStaticNodesAsync = function (networkName) {
        return __awaiter(this, void 0, void 0, function () {
            var bucketName, fileName;
            return __generator(this, function (_a) {
                bucketName = StaticNodesGoogleStorageBucketName;
                fileName = networkName;
                return [2 /*return*/, google_storage_utils_1.GoogleStorageUtils.fetchFileFromGoogleStorage(bucketName, fileName)];
            });
        });
    };
    return StaticNodeUtils;
}());
