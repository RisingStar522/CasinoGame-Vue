...
exports.Signature = exports.AzureKeyVaultClient = void 0;
...
var AzureKeyVaultClient = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        rBuff = AzureKeyVaultClient.bigNumberToBuffer(R, 32);
                        sBuff = AzureKeyVaultClient.bigNumberToBuffer(S, 32);
    ...
    AzureKeyVaultClient.bigNumberToBuffer = function (input, lengthInBytes) {
        var hex = input.toString(16);
        var hexLength = lengthInBytes * 2; // 2 hex characters per byte.
        if (hex.length < hexLength) {
            hex = '0'.repeat(hexLength - hex.length) + hex;
        }
        return ethUtil.toBuffer(address_1.ensureLeading0x(hex));
    };
    /**
