...
export declare const stringToSolidityBytes: (input: string) => string | number[];
export declare const bufferToSolidityBytes: (input: Buffer) => string | number[];
...
export declare class CeloTransactionObject<O> {
    ...
    readonly defaultParams?: Pick<Tx, "feeCurrency" | "gatewayFeeRecipient" | "gatewayFee" | "nonce" | "from" | "to" | "value" | "gas" | "gasPrice" | "chainId" | "common" | "chain" | "hardfork"> | undefined;
    constructor(kit: ContractKit, txo: TransactionObject<O>, defaultParams?: Pick<Tx, "feeCurrency" | "gatewayFeeRecipient" | "gatewayFee" | "nonce" | "from" | "to" | "value" | "gas" | "gasPrice" | "chainId" | "common" | "chain" | "hardfork"> | undefined);
    /** send the transaction to the chain */
    send: (params?: Pick<Tx, "feeCurrency" | "gatewayFeeRecipient" | "gatewayFee" | "nonce" | "from" | "to" | "value" | "gas" | "gasPrice" | "chainId" | "common" | "chain" | "hardfork"> | undefined) => Promise<TransactionResult>;
    /** send the transaction and waits for the receipt */
    sendAndWaitForReceipt: (params?: Pick<Tx, "feeCurrency" | "gatewayFeeRecipient" | "gatewayFee" | "nonce" | "from" | "to" | "value" | "gas" | "gasPrice" | "chainId" | "common" | "chain" | "hardfork"> | undefined) => Promise<TransactionReceipt>;
}
export {};
