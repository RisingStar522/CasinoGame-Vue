...
var string_1 = require("@celo/utils/lib/string");
...
var AttestationsWrapper = /** @class */ (function (_super) {
    ...
    AttestationsWrapper.prototype.revoke = function (identifer, account) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contract.methods.lookupAccountsForIdentifier(identifer).call()];
                    case 1:
                        accounts = _a.sent();
                        ...
                        return [2 /*return*/, BaseWrapper_1.toTransactionObject(this.kit, this.contract.methods.revoke(identifer, idx))];
                }
            });
        });
    };
