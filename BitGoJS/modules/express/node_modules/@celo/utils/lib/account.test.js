        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, account_1.generateKeys(mnemonics[i])];
                case 2:
                    derivation0 = _a.sent();
                    return [4 /*yield*/, account_1.generateKeys(mnemonics[i], undefined, 0, 1)];
                case 3:
                    derivation1 = _a.sent();
                    return [4 /*yield*/, account_1.generateKeys(mnemonics[i], 'password')];
                case 4:
                    password = _a.sent();
