...
proto.proto.TransferList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    BasicTypes_pb.AccountAmount.toObject, includeInstance)
  };
...
proto.proto.TransferList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new BasicTypes_pb.AccountAmount;
      reader.readMessage(value,BasicTypes_pb.AccountAmount.deserializeBinaryFromReader);
...
proto.proto.TransferList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      BasicTypes_pb.AccountAmount.serializeBinaryToWriter
    );
  }
};
...
proto.proto.TransferList.prototype.getAccountamountsList = function() {
  return /** @type{!Array<!proto.proto.AccountAmount>} */ (
    jspb.Message.getRepeatedWrapperField(this, BasicTypes_pb.AccountAmount, 1));
};
