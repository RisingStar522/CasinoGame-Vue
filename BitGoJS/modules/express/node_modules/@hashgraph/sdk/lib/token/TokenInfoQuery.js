...
class TokenInfoQuery extends QueryBuilder_1.QueryBuilder {
    ...
    _mapResponse(response) {
        ...
        return {
            ...
            adminKey: PublicKey_1._fromProtoKey(info.getAdminkey()),
            kycKey: PublicKey_1._fromProtoKey(info.getKyckey()),
            freezeKey: PublicKey_1._fromProtoKey(info.getFreezekey()),
            wipeKey: PublicKey_1._fromProtoKey(info.getWipekey()),
            supplyKey: PublicKey_1._fromProtoKey(info.getSupplykey()),
