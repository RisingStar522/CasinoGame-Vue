...
const TokenTransfer_pb_1 = require("../generated/TokenTransfer_pb");
...
class TokenTransferTransaction extends TransactionBuilder_1.SingleTransactionBuilder {
    constructor() {
        super();
        this._body = new TokenTransfer_pb_1.TokenTransfersTransactionBody();
    ...
    _doValidate(_) { }
    get _method() {
        return TokenService_pb_service_1.TokenService.transferTokens;
    }
}
