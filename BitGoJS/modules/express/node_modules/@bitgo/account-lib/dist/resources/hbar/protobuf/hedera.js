...
$root.proto = (function() {
    ...
    proto.NodeAddressBook = (function() {
        ...
        NodeAddressBook.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.NodeAddressBook();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        NodeAddressBook.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.NodeAddressBook)
                return object;
            var message = new $root.proto.NodeAddressBook();
    ...
    proto.Transaction = (function() {
        ...
        Transaction.verify = function verify(message) {
            ...
            if (message.body != null && message.hasOwnProperty("body")) {
                ...
                {
                    var error = $root.proto.TransactionBody.verify(message.body);
                    if (error)
                        return "body." + error;
                }
            }
