 ...
 * @param primaryKeyCurve The elliptic curve for this chain/token
 */
export declare function erc20(name: string, fullName: string, decimalPlaces: number, contractAddress: string, asset: UnderlyingAsset, features?: CoinFeature[], prefix?: string, suffix?: string, network?: AccountNetwork, primaryKeyCurve?: KeyCurve): Readonly<Erc20Coin>;
/**
 ...
 * @param primaryKeyCurve The elliptic curve for this chain/token
 */
export declare function erc20CompatibleAccountCoin(name: string, fullName: string, network: AccountNetwork, decimalPlaces: number, contractAddress: string, asset: UnderlyingAsset, features?: CoinFeature[], prefix?: string, suffix?: string, primaryKeyCurve?: KeyCurve): Readonly<Erc20CompatibleAccountCoin>;
/**
 ...
 * @param primaryKeyCurve The elliptic curve for this chain/token
 */
export declare function celoToken(name: string, fullName: string, decimalPlaces: number, contractAddress: string, asset: UnderlyingAsset, features?: CoinFeature[], prefix?: string, suffix?: string, network?: AccountNetwork, primaryKeyCurve?: KeyCurve): Readonly<CeloCoin>;
/**
 ...
 * @param features? Features of this coin. Defaults to the DEFAULT_FEATURES defined in `AccountCoin`
 */
export declare function tceloToken(name: string, fullName: string, decimalPlaces: number, contractAddress: string, asset: UnderlyingAsset, features?: CoinFeature[], prefix?: string, suffix?: string, network?: AccountNetwork): Readonly<CeloCoin>;
/**
